...
extern int CCD_Value[128] = {0};     //CCD的值 不带DMA
extern u16 DMA_CCD_Value[128] = {0}; //CCD的值 使用DMA
...
void CCD_Find_Mid_Nd();  //找中线 无CCD
void CCD_Init_DMA(void); //DMA_CCD初始化
void DMA_Read_CCD();     //DMA_CCD读值
void DMA_CCD_Find_Mid(); //DMA_CCD找中线
#endif
